...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:zaTZ6rL7kMWQD41H@cluster0.cmro6ud.mongodb.net/?retryWrites=true&w=majority";
        ...
        Bson ratingStringFilter = new Document("imdb.rating", "string");
